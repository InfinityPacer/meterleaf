...
| 页面     | 内容                                                         | 时间范围                                           |
| -------- | ------------------------------------------------------------ | -------------------------------------------------- |
| 用量总览 | 所选范围的摘要、账户额度、消耗趋势与模型分布                 | 默认历史至今，可切换，账户额度始终按当前周期       |
...
手机默认使用 App 模式，底部为首页、账户、统计、明细和我的。首页顶部可在全部、近 7 天和近 30 天之间切换，日历按钮提供其它范围。可在“我的”中切换为侧栏模式；导航模式和主题会记住，重新打开仍然生效。
